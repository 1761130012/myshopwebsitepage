<template>
  <div>
    ...
    <el-form :inline="true" :model="queryParams">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-plus" size="small"
                   v-if="$store.getters.getMenuPerms('system:user:add')"
                   @click="handleAdd">新增
        </el-button>
      </el-form-item>
      <el-form-item>
        <el-button type="warning" icon="el-icon-edit" size="small" :disabled="single"
                   v-if="$store.getters.getMenuPerms('system:user:edit')"
                   @click="handleUpdate">修改
        </el-button>
      </el-form-item>
      <el-form-item>
        <el-button type="danger" icon="el-icon-delete" size="small" :disabled="multiple"
                   v-if="$store.getters.getMenuPerms('system:user:remove')"
    ...
    <el-table :data="userList" v-loading="loading"
      ...
      <el-table-column prop="createTime" label="创建时间" value-format="yyyy-MM-dd HH:mm:ss" min-width="120"
