  ...
  <div>
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item>
        <el-button type="primary" icon="el-icon-plus" size="small"
                   @click="handleAdd"
                   v-if="$store.getters.getMenuPerms('system:menu:add')"
        >新增
        </el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading" :data="menuList" row-key="menuId"
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <div v-if="$store.getters.getMenuPerms('system:menu:edit')">
            <el-tooltip class="item" effect="dark" content="修改" placement="top-start">
              <el-button type="warning" icon="el-icon-edit" @click="handleUpdate(scope.row)" size="small"></el-button>
            </el-tooltip>
          </div>
          <div v-if="$store.getters.getMenuPerms('system:menu:remove')">
