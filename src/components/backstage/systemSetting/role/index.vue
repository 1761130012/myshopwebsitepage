  ...
  <div>
    ...
    <el-form :inline="true" :model="queryParams" class="demo-form-inline">
      <el-form-item label="员工名">
        <el-input v-model="queryParams.name" placeholder="请输入角色名" clearable></el-input>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <el-button
          ...
          size="small"
          @click="handleAdd"
          v-if="$store.getters.getMenuPerms('system:role:add')"
        >新增
        </el-button>
      </el-form-item>
      <el-form-item>
        <el-button
          ...
          size="small"
          :disabled="single"
          v-if="$store.getters.getMenuPerms('system:role:edit')"
          @click="handleUpdate"
        >修改
        </el-button>
      </el-form-item>
      <el-form-item>
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-if="$store.getters.getMenuPerms('system:role:remove')"
        >删除
        </el-button>
      </el-form-item>
    </el-form>
